...
@interface SignUpUserInfoViewController ()<CircleImageAddDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, GMSAutocompleteViewControllerDelegate>
{
...
- (IBAction)onCheck:(id)sender {
    ...
    if(error.length > 0){
        ...
        self.userInfo[PARSE_USER_GEOPOINT] = [PFGeoPoint new];
